    ...
    return (
        <div className="interactive-section">
            ...
            <div className="home-alltext" style={{marginBottom: "32px"}}>
                <h1>Interactive</h1>
                <p>Interactive activities allow you to test your math skills with randomly generated problems. Activities vary from algebra to trigonometry to calculus. Email admin@mathinfo.org for requests.</p>
            </div>
